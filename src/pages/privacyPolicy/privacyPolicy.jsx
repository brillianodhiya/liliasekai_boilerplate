...
const PrivacyPolicy = () => {
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", margin: "64px" }}>
      <strong>Privacy Policy</strong>{" "}
      <p>
        IoT Kreasi Indonesia built the IKI Teknisi app as a Free app. This
        SERVICE is provided by IoT Kreasi Indonesia at no cost and is intended
        for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at IKI Teknisi unless
      ...
      <p>
        ...
        but not limited to Images. The information that we request will be
      ...
      <p>This policy is effective as of 2021-02-24</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at iotkreasi.id(at)gmail.com.
      </p>
    </div>
  );
};
